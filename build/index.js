    ...
    async processQuery(query) {
        ...
        if (response.message.tool_calls) {
            for (let content of response.message.tool_calls) {
                ...
                const toolArgs = content.function.arguments;
                ...
                const arrayResult = result.content;
                ...
                messages.push({
                    role: 'tool',
                    content: flattened, // ← now a string
                });
                const response = await this.ollama.chat({
                    model: OLLAMA_MODEL,
                    messages,
                ...
                finalText.push(response.message.content ? response.message.content : "");
            }
        }
        else {
